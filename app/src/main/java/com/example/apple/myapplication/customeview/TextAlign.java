 ...
 */
public class TextAlign extends View{
    ...
    public TextAlign(Context context) {
        super(context);
        init();
    }

    public TextAlign(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TextAlign(Context context, AttributeSet attrs, int defStyleAttr) {
